  ...
  const renderShareDefault = () => {
    return (
      <div className="form__share__boxTwo js_boxTwo js_share_box2">
        ...
        <Loader showLoading={props.showLoading} />
      </div>
    );
  };
    ...
    return (
      <>
        ...
        <section className="form__collapsible js_share_section">
          <h2 className="form__collapsible__cardUrl-message">
            La tarjeta ha sido creada:
          </h2>
          <a
            className="form__collapsible__cardUrl"
